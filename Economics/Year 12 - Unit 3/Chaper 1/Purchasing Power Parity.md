Purchasing Power parity refers to the idea that the **smaeproduct should sell for the same price** in different countries, **once converted to a common [[Exchange Rate|exchange rate]]**.
